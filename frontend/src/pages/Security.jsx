...
- Uploaded photographs (JPEG/PNG/GIF/WebP formats only; a plan-based photo allowance per report, sent to the vision model in batches of up to 10 images per request)
